...
The repo for this support is located `here <https://github.com/joneja09/ForgePoint.Identity/tree/main/src/AspNetIdentity>`_ and the NuGet package is `here <https://www.nuget.org/packages/ForgePoint.Identity.AspNetIdentity>`_.
