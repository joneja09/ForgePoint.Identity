...
Use the IdentityModel `introspection handler <https://github.com/IdentityModel/IdentityModel.AspNetCore.OAuth2Introspection>`_
for reference tokens, and ``Microsoft.AspNetCore.Authentication.JwtBearer`` for JWTs. To accept both in one API, see :ref:`Protecting APIs <refProtectingApis>`.
