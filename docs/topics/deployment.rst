...
For databases we provide support for `Entity Framework Core <https://github.com/joneja09/ForgePoint.Identity/tree/main/src/EntityFramework>`_ based databases.
