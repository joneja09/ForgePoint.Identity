...
namespace IdentityServer.UnitTests.Hosting
{
    ...
    {
        private Dictionary<string, ForgePoint.Identity.Hosting.Endpoint> _pathMap;
        private List<ForgePoint.Identity.Hosting.Endpoint> _endpoints;
        private IdentityServerOptions _options;
        private EndpointRouter _subject;

        public EndpointRouterTests()
        {
            _pathMap = new Dictionary<string, ForgePoint.Identity.Hosting.Endpoint>();
            _endpoints = new List<ForgePoint.Identity.Hosting.Endpoint>();
        ...
        {
            Action a = () => new ForgePoint.Identity.Hosting.Endpoint("ep1", "ep1", typeof(MyEndpointHandler));
        ...
        {
            _endpoints.Add(new ForgePoint.Identity.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new ForgePoint.Identity.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new ForgePoint.Identity.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new ForgePoint.Identity.Hosting.Endpoint("ep1", "/ep1", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new ForgePoint.Identity.Hosting.Endpoint(EndpointNames.Authorize, "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new ForgePoint.Identity.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
